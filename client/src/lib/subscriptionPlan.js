...
export const PLAN_PRICE = "Rp35.999"; // TODO: ganti harga langganan per bulan
export const PLAN_DURATION = "30 hari";

export const BANK_NAME = "BCA"; // TODO: ganti nama bank/e-wallet
export const BANK_ACCOUNT_NUMBER = "1234567890"; // TODO: ganti nomor rekening
export const BANK_ACCOUNT_NAME = "Nama Pemilik Rekening"; // TODO: ganti nama pemilik
